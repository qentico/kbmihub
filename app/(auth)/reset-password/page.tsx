...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // The PASSWORD_RECOVERY event fires during Supabase client init (hash processing),
    // which happens before useEffect runs. Check existing session first to catch it.
